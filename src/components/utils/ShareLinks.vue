...
<div id="share-links" :class="themeClass">
  <div class="d-flex justify-content-left">
    <DownloadImage class="mr-3 mb-3" :image="gaiaAsset.image" :name="'asset-' + gaiaAsset.contractAsset.nftIndex" />
  </div>
</div>
</template>

<script>
import DownloadImage from '@/views/marketplace/components/gallery/DownloadImage'
