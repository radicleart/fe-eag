...
<div class="bg-light" style="height: 100%;">
  <div class="p-2 px-3 bg-light" style="margin-bottom: 0.1rem;"><b-link class="text-primary" :to="'/nft-collection/' + loopRun.currentRunKey">{{loopRun.currentRun}}</b-link></div>
