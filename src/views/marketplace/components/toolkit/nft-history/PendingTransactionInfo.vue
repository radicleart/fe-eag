...
export default {
  ...
  methods: {
    txMessage: function () {
      ...
      } else if (this.pending.functionName === 'buy-in-ustx') {
        return 'Buying in Progress'
      } else if (this.pending.functionName === 'unlist-in-ustx') {
        return 'Unlist in Progress'
      } else if (this.pending.functionName === 'list-in-ustx') {
