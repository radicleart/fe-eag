...
<div class="mt-3" v-if="!loading">
  <h4>Royalties on Secondary Sales</h4>
    <b-row class="mb-2 text-warning">
      <b-col :cols="(hidePrimaries) ? 8 : 6">Address</b-col>
      <b-col class="text-right" cols="3" v-if="!hidePrimaries">Primary</b-col>
      <b-col class="text-right" :cols="(hidePrimaries) ? 4 : 3">Secondary</b-col>
    </b-row>
