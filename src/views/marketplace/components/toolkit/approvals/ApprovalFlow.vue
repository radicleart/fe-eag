    ...
    <b-card class="border-dark p-3" style="width: 100%;" bg-variant="dark" header-tag="header" footer-tag="footer">
      <b-card-text class="text-whiter">
        ...
        <div class="col-12 mb-4">
          <b-input-group append="ADDR" class="mb-3">
            <b-form-input v-model="operator" placeholder="STX Address of the operator / marketplace"></b-form-input>
          </b-input-group>
          <p class="text-xsmall">An address you trust (normally a marketplace or DAO contract).</p>
          <p class="text-xsmall">Note: the approval applies for one sale cycle only.</p>
        </div>
